    ...
    <div class="container mx-auto px-4">
        <div class="max-w-3xl mx-auto text-center mb-16">
            ...
            <h2 class="text-4xl md:text-5xl font-bold text-gray-900 mb-6" data-aos="fade-up" data-aos-delay="100">
                Otras características de CRM Fisio Inteligente
            </h2>
            <p class="text-xl text-gray-600" data-aos="fade-up" data-aos-delay="200">
                Descubre todas las herramientas que tenemos para potenciar tu clínica de fisioterapia
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <a href="{{ route('features.appointments') }}" class="group bg-white p-6 rounded-xl shadow-sm hover:shadow-xl transition-all transform hover:-translate-y-1" data-aos="fade-up">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-2">Gestión de Citas</h3>
                <p class="text-gray-600 mb-4">Sistema inteligente para programación, recordatorios y confirmaciones automáticas.</p>
            ...
            <a href="{{ route('features.clinical-history') }}" class="group bg-white p-6 rounded-xl shadow-sm hover:shadow-xl transition-all transform hover:-translate-y-1" data-aos="fade-up" data-aos-delay="100">
                ...
                <p class="text-gray-600 mb-4">Expedientes digitales completos con búsqueda inteligente y análisis de datos.</p>
                <div class="flex items-center text-emerald-600 font-semibold">
                    <span>Ver detalles</span>
                    <svg class="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"/>
            ...
            <a href="{{ route('features.virtual-assistant') }}" class="group bg-white p-6 rounded-xl shadow-sm hover:shadow-xl transition-all transform hover:-translate-y-1" data-aos="fade-up" data-aos-delay="200">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-2">Asistente Virtual</h3>
                <p class="text-gray-600 mb-4">Chatbot inteligente para atención 24/7, reservas y resolución de consultas.</p>
                <div class="flex items-center text-emerald-600 font-semibold">
                    <span>Ver detalles</span>
                    <svg class="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"/>
            ...
            <a href="{{ route('features.ai-calls') }}" class="group bg-white p-6 rounded-xl shadow-sm hover:shadow-xl transition-all transform hover:-translate-y-1" data-aos="fade-up">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-2">Asistente de Llamadas IA</h3>
                <p class="text-gray-600 mb-4">Gestión automática de llamadas con reconocimiento de voz y procesamiento de lenguaje natural.</p>
                <div class="flex items-center text-emerald-600 font-semibold">
                    <span>Ver detalles</span>
                    <svg class="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"/>
            ...
            <a href="{{ route('features.billing') }}" class="group bg-white p-6 rounded-xl shadow-sm hover:shadow-xl transition-all transform hover:-translate-y-1" data-aos="fade-up" data-aos-delay="100">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-2">Facturación Inteligente</h3>
                <p class="text-gray-600 mb-4">Sistema automatizado de facturación con recordatorios de pago y análisis financiero.</p>
                <div class="flex items-center text-emerald-600 font-semibold">
                    <span>Ver detalles</span>
                    <svg class="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"/>
            ...
            <a href="{{ route('features.marketing') }}" class="group bg-white p-6 rounded-xl shadow-sm hover:shadow-xl transition-all transform hover:-translate-y-1" data-aos="fade-up" data-aos-delay="200">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-2">Marketing para Fisioterapia</h3>
                <p class="text-gray-600 mb-4">Campañas automáticas personalizadas para captar y fidelizar pacientes con análisis de resultados.</p>
                <div class="flex items-center text-emerald-600 font-semibold">
                    <span>Ver detalles</span>
                    <svg class="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"/>
